...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const initViewCounter = async () => {
    ...
    try {
      // Use free, public, CORS-enabled counterapi.dev service keyed to project and key
      const response = await fetch('https://api.counterapi.dev/v1/kakababu-bistro-cafe-v2/views/increment');
      if (response.ok) {
