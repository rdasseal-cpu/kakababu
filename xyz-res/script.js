...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (isDesktop && cursorDot && cursorGlow) {
    ...
    const clickables = document.querySelectorAll('a, button, input, select, textarea, .bento-card, .polaroid-card, .review-screenshot-card, .review-summary-card, .dot, .menu-card-container, [role="button"]');
